...
open class TagListView: UIView {
    ...
    private func createNewTagView(_ title: String) -> TagView {
        ...
        tagView.selectedBackgroundColor = UIColor(red: 0/255.0, green: 202/255.0, blue: 173/255.0, alpha: 1.0)
       // tagView.titleLineBreakMode = tagLineBreakMode
        tagView.cornerRadius = cornerRadius
        tagView.borderWidth = 1
        tagView.borderColor = UIColor.lightGray
        tagView.selectedBorderColor = UIColor(red: 0/255.0, green: 202/255.0, blue: 173/255.0, alpha: 1.0)
