//
//  FilterVendorViewController.swift
//  Mars
//
//  Created by Arpit Lokwani on 09/09/19.
//  Copyright © 2019 Arpit Lokwani. All rights reserved.
//

import UIKit

class FilterVendorViewController: UIViewController, TagListViewDelegate {
    ...
    @IBAction func applyNowBtnPressed(_ sender: Any) {
       ...
       print(self.appDelegate.selectedVendorFlavorList)
        ...
        UserDefaults.standard.setValue(self.appDelegate.selectedFlavorIDForVendor, forKey: "vendorSelectedFlavourIDs")
        UserDefaults.standard.setValue(self.appDelegate.selectedVendorlegacyIDList, forKey: "vendorSelectedLegacyIDList")
        UserDefaults.standard.setValue(self.appDelegate.selectedVendorCountryIDList, forKey: "vendorSelectedCountryIDList")
        UserDefaults.standard.setValue(isAllCountrySelected, forKey: "isAllCountrySelectedVendor")
        navigationController?.popViewController(animated: true)
        
        UserDefaults.standard.setValue(self.appDelegate.selectedVendorCatIdListArr, forKey: "selectedVendorCatIdList")
...
//        self.navigationController?.pushViewController(swiftViewController, animated: true)
    ...
    override func viewDidLoad() {
        ...
        let request = URLRequest(url: URL(string: "http://mars.bizofit.com/api/v1/user/getFilterVendorValues")!)
        ...
        if tagView.isSelected {
            ...
            if(appDelegate.selectedVendorFlavorList.count>0){
               ...
               self.appDelegate.selectedVendorFlavorList.remove(tagView.titleLabel!.text!)
                    ...
                    self.appDelegate.selectedVendorCatIdListArr.remove(id)
