...
public struct SlideMenuOptions {
    ...
    public static var contentViewOpacity: CGFloat = 1
...
extension UIViewController {
    ...
    public func addLeftBarButtonWithImage(_ buttonImage: UIImage) {
        ...
        menuBtn.frame = CGRect(x: 15, y: 10, width: 25, height: 20)
        menuBtn.setBackgroundImage(UIImage(named: "menu_copy"), for: .normal)
        menuBtn.addTarget(self, action: #selector(self.toggleLeft), for: .touchUpInside)
        
        
       // let leftButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItemStyle.plain, target: self, action: #selector(self.toggleLeft))
        navigationItem.title = "MARS"
        
        self.navigationController?.navigationBar.titleTextAttributes =
            [NSAttributedStringKey.foregroundColor: UIColor.white,
             NSAttributedStringKey.font:UIFont(name: "HelveticaNeue-Bold", size: 26.0)!];
    ...
    public func addRightBarButtonWithImage(_ buttonImage: UIImage) {
        let menuBtn = UIButton()
        menuBtn.frame = CGRect(x: view.frame.size.width-35, y: 5, width: 25, height: 25)
        menuBtn.setBackgroundImage(UIImage(named: "filter_icon"), for: .normal)
        menuBtn.addTarget(self, action: #selector(self.toggleRight), for: .touchUpInside)
        self.navigationController?.navigationBar.addSubview(menuBtn)
...
//        navigationItem.rightBarButtonItem = rightButton
    ...
    @objc public func toggleRight() {
        ...
        let swiftViewController = storyboard.instantiateViewController(withIdentifier: "FilterViewController") as! FilterViewController
