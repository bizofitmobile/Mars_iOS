...
//  Mars
//
//  Created by Arpit Lokwani on 31/08/19.
//  Copyright © 2019 Arpit Lokwani. All rights reserved.
//

import UIKit
import EasyTipView
class VendorViewController: UIViewController,UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,VendorCheckBoxDelegate {
    ...
    @IBAction func filterBtnAction(_ sender: Any) {
        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "FilterVendorViewController") as? FilterVendorViewController
    ...
    func updateSearchData(value:String)  {
        ...
        let parameters:[String:Any] = ["search":"\(value)",
            "flavour_ids": arr
            
        ]
        
        var request = URLRequest(url: URL(string: "http://mars.bizofit.com/api/v1/user/getVendorsList")!)
            ...
            do {
                ...
                if(dataArr.count>0){
                    ...
                    for i in 0...dataArr.count-1{
                        ...
                        print(dict.value(forKey: "country")!)
                        print(dict.value(forKey: "email")!)
                        print(dict.value(forKey: "flavour_name")!)
                        print(dict.value(forKey: "legecy")!)
                        print(dict.value(forKey: "price")!)
                        print(dict.value(forKey: "name")!)
                        print(dict.value(forKey: "mars_sourcing")!)
                        print(dict.value(forKey: "vendor_id")!)
                        print(dict.value(forKey: "flavour_id")!)
                        print(dict.value(forKey: "product_id")!)
                        
                        
                        
                        
                        
                        self.flavourName.add(dict.value(forKey: "flavour_name")!)
                        self.vendorName.add(dict.value(forKey: "name")!)
                        ...
                        self.flavorIDArr.add(dict.value(forKey: "flavour_id")!)
    ...
    func getVendorsList() -> Void {
        ...
        if userdefaults.array(forKey: "vendorSelectedFlavourIDs") != nil{
            selectedCatArr = userdefaults.array(forKey: "selectedVendorCatIdList")! as NSArray
        }
        ...
        print(selectedFlavourArr)
        print(selectedListIDArr)
    ...
    override func viewDidLoad() {
        ...
        if let isLaunched = UserDefaults.standard.string(forKey: "isVendorPageLaunched") {
            if (isLaunched == "YES"){
                // do nothing
            }else{
                UserDefaults.standard.set("YES", forKey: "isVendorPageLaunched")
            }
        }else{
            UserDefaults.standard.set("YES", forKey: "isVendorPageLaunched")
//            EasyTipView.show(forView: searchBar,
//                             withinSuperview: self.navigationController?.view,
//                             text: "Select anyone vendor to send the request for Sample. Click on Done to move to next screen and type/edit your message ",
//                             preferences: preferences,
//                             delegate: nil)
        }
        
        let userDefaults = UserDefaults.standard
        userDefaults.removeObject(forKey: "vendorSelectedLegacyIDList")
        userDefaults.removeObject(forKey: "vendorSelectedCountryIDList")
        userDefaults.removeObject(forKey: "vendorSelectedFlavourIDs")
        userDefaults.removeObject(forKey: "isAllCountrySelectedVendor")
 ...
 */
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       // selectedIndexForCategory = indexPath.row
        ...
        subContentsVC.productId = self.productIDArr[indexPath.row] as! String
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       cell.delegate = self
        ...
        cell.flavorHeaderLabel.text = "FLAVOR"
...
extension VendorViewController: SlideMenuControllerDelegate {
